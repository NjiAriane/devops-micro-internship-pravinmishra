...
![VPC details showing CIDR](screenshots/VPC-details-showing-CIDR-ass4.png)
...
![Subnets list showing both subnets](screenshots/Subnets-list-showing-both-subnets-ass4.png)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![Route table showing IGW and association](screenshots/Route-table-showing-IGW-and-association-ass4.png)
...
![EC2 security group inbound rules](screenshots/EC2-sg-inbound-rules-showing-ports-and-sources-ass4.png)

---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![RDS security group inbound rule](screenshots/RDS-sg-inbound-rule-showing-ass4.png)
...
![EC2 instance summary](screenshots/EC2-instance-summary-ass4.png)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![Terminal showing successful SSH login](screenshots/Terminal-showing-successful-SSH-login.png)
...
![Node.js version](screenshots/node-version-ass4.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![Nginx service status](screenshots/systemctl-status-nginx-ass4.png)

---

#### Screenshot 10 — Output of `mysql --version`

![MySQL client version](screenshots/mysql--version-ass4.png)
...
![RDS instance summary](screenshots/RDS-instance-summary-showing-ass4.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![RDS connectivity and security](screenshots/Connectivity-and-security-section-showing-theVPC-attached-ass4.png)
...
![SHOW TABLES output](screenshots/Terminal-showing-successful-SHOWTABLES-ass4.png)
...
![EpicBook repository cloned](screenshots/Terminal-showing-repository-cloned-and-ls-output-ass4.png)

---

#### Screenshot 15 — Terminal showing the backend running, or `ss -tulpn` showing the port open

![Backend running and port 3000](screenshots/Terminal-showing-backend-running-ss-tulpn-ass4.png)

---

#### Screenshot 16 — `curl` output proving the backend responds; a 200, 301, or 404 response is acceptable if the service responds

![Backend curl response](screenshots/curl-output-proving-backend-responds-ass4.png)
...
![Nginx configuration test](screenshots/nginx-t-success-output-ass4.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![Nginx API reverse proxy configuration](screenshots/Nginx-configuration-snippet-showing-the-api-reverse-proxy-ass4.png)
...
![EpicBook application loaded](screenshots/Browser-showing-EpicBook-application-with-pubIP-ass4.png)

---

#### Screenshot 20 — Terminal showing a successful API call through the public endpoint, such as `curl http://<EC2_PUBLIC_IP>/api/...`

![Successful public API call](screenshots/Terminal-showing-successful-API-call-through-public-endpoint-ass4.png)

---

#### Screenshot 21 — Terminal showing the successful database connectivity test using `SELECT 1;` or similar

![Successful database connectivity test](screenshots/Terminal-showing-successful-database-connectivity-test-using-SELECT-1-ass4.png)
---
