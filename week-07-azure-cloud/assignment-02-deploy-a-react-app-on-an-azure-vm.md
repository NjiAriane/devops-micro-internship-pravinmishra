...
![Screenshot 1 — Resource Group overview](screenshots/assignment-02-screenshot-01-resource-group.png)
...
![Screenshot 2 — Azure VM overview](screenshots/Screenshot-2-Azure-VM-Overview.png)

---

#### Screenshot 3 — Network Security Group inbound rules showing ports 22 and 80 allowed

![Screenshot 3 — NSG inbound rules](screenshots/Screenshot-3-NSG-Inbound-Rules.png)
---
...
![Screenshot 4 — SSH login](screenshots/Screenshot-4-SSH-Login.png)
...
![Screenshot 5 — Node.js and npm versions](screenshots/Screenshot-5-Node-Npm.png)
...
![Screenshot 6 — React app build](screenshots/Screenshot-6-React-App-Build.png)
...
![Screenshot 7 — Nginx configuration test](screenshots/Screenshot-7-Nginx-Test.png)

---

#### Screenshot 8 — Nginx configuration snippet showing the build root and `try_files` directive

![Screenshot 8 — Nginx configuration](screenshots/Screenshot-8-Nginx-Configuration.png)
...
![Screenshot 9 — React app deployed via public IP](screenshots/Screenshot-9-React-App-Public-IP1.png)
...
![Screenshot 10 — SSH hardening](screenshots/Screenshot-10-SSH-Hardening.png)
